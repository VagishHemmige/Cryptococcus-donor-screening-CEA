...
The full analysis Github website is available at https://vagishhemmige.github.io/Cryptococcus-donor-screening-CEA/
...
## Tornado diagrams
One-way sensitivity analysis yields the following tornado diagrams for cost and QALYs:
![Cost tornado diagram](figures/tornado_cost.svg)
![QALY tornado diagram](figures/tornado_qaly.svg)

## Probabilistic sensitivity analysis
We perform 10,000 simulations, yielding the following results for sensitivity analysis:
![PSA plot](figures/PSA_plot.svg)