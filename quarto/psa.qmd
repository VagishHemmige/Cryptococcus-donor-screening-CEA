...
Of note, since all QALY data are relative to a baseline where there is no transplant performed, `q_noacceptance` are parameterized, not as functions of the gamma distribution, but as fixed constants set at 0.
...
We create a cost effectiveness plane with 95% confidence ellipse marked in red below:
